				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix content">
						...
						<div class="clearfix single_content newsletter">
                            <form action=<?php echo "./index.php?page=ClasseAnnonce"; ?> method="post">
                                <legend class="legende">Publier une annonce:</legend>
                                <input type="text" name="titre_annonce" placeholder="Titre de l'annonce"><br />
                                <textarea  name="annonce" placeholder="Annonce"></textarea><br />
						...
						<div class="clearfix single_content">
							...
							<div class="clearfix post_detail">
								...
								<div class="clearfix post_excerpt">
									<p><b><?php echo $annonce['ANNONCE']; ?></b></p><br>
								</div>
							</div>
						</div>
